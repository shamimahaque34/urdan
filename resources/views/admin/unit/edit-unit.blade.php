                ...
                <div class="col-lg-10">
                    ...
                    <div class="card shadow border-dark">
                        <div class="card-header bg-dark">
                            <h3 class="text-center text-warning">Edit Unit</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('update-unit') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="name" id="name" value="{{ $unit->name }}" class="form-control border-dark">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea name="description" id="description" class="form-control border-dark">{{ $unit->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="submit" value="Update Unit" class="btn btn-dark text-warning btn-block" style="cursor: pointer;">
                                        </div>
                                    </div>
                                </div>
                            </form>
