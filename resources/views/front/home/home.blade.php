                            ...
                            <div class="product-wrap" data-aos="fade-up" data-aos-delay="200">
                                <div class="product-img img-zoom mb-25">
                                    ...
                                    <div class="product-action-wrap">
                                        ...
                                        <button class="product-action-btn-1 showModal" title="Quick View" data-id="{{ $product->id }}" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="home-single-product-img" data-aos="fade-up" data-aos-delay="200">
                        <a href="{{ route('product-details',['id'=>5]) }}"><img src="{{ asset('/') }}assets/images/product/single-product.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="200">
                                <div class="product-img img-zoom mb-25">
                                    <a href="{{ route('product-details',['id'=>5]) }}">
                                ...
                                <div class="product-content">
                                    <h3><a href="{{ route('product-details',['id'=>5]) }}">Interior moderno render</a></h3>
                                    <div class="product-price">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="product-content">
                                    <h3><a href="{{ route('product-details',['id'=>5]) }}">Stylish Dining Chair</a></h3>
                                    <div class="product-price">
                                        <span>$50.25 </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <div class="product-content">
                                    <h3><a href="{{ route('product-details',['id'=>5]) }}">Round Standard Chair</a></h3>
                                    <div class="product-price">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="800">
                                ...
                                <div class="product-content">
                                    <h3><a href="{{ route('product-details',['id'=>5]) }}">Stylish Swing Chair</a></h3>
                                    <div class="product-price">
                                        <span>$30.25 </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="product-content">
                                    <h3><a href="{{ route('product-details',['id'=>5]) }}">Modern Swivel Chair</a></h3>
                                    <div class="product-price">
                                        <span class="old-price">$25.89 </span>
                                        <span class="new-price">$20.25 </span>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="product-content">
                                    <h3><a href="{{ route('product-details',['id'=>5]) }}">New Modern Sofa Set</a></h3>
                                    <div class="product-price">
                                        <span>$50.25 </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <div class="product-content">
                                    <h3><a href="{{ route('product-details',['id'=>5]) }}">Easy Modern Chair</a></h3>
                                    <div class="product-price">
                                        <span class="old-price">$45.00 </span>
                                        <span class="new-price">$40.00 </span>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="800">
                                ...
                                <div class="product-content">
                                    <h3><a href="{{ route('product-details',['id'=>5]) }}">Modern Lounge Chairs</a></h3>
                                    <div class="product-price">
                                        <span>$30.25 </span>
                                    </div>
                                </div>
